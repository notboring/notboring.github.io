...
var spritesheet_Main = function() {
	pixi_plugins_app_Application.call(this);
	this._init();
};
spritesheet_Main.main = function() {
	new spritesheet_Main();
};
spritesheet_Main.__super__ = pixi_plugins_app_Application;
spritesheet_Main.prototype = $extend(pixi_plugins_app_Application.prototype,{
	_init: function() {
		this.position = "fixed";
	...
	,_onLoaded: function() {
		...
		while(_g < 29) {
			...
			this._fighterTextures.push(PIXI.Texture.from("rollSequence00" + frame + ".png"));
		}
	...
	,_onUpdate: function(elapsedTime) {
		if(this._isAdding) {
			this._addFighter(Std.random(window.innerWidth),Std.random(window.innerHeight));
		}
	}
	,_addFighter: function(x,y) {
		var fighter = new PIXI.AnimatedSprite(this._fighterTextures);
	...
	,_addCounter: function() {
		this._counter = window.document.createElement("div");
