...
var filters_glow_Main = function() {
	pixi_plugins_app_Application.call(this);
	this._init();
	this._container = new PIXI.Container();
	this.stage.addChild(this._container);
	this._container.position.set(window.innerWidth / 2,window.innerHeight / 2);
	this._littleRobot = PIXI.Sprite.from("assets/filters/depth_blur_moby.jpg");
	this._littleRobot.anchor.set(0.5);
	this._container.addChild(this._littleRobot);
	this._littleRobot.filters = [new PIXI.filters.GlowFilter(15,2,1,16711680,0.5)];
};
filters_glow_Main.main = function() {
	new filters_glow_Main();
};
filters_glow_Main.__super__ = pixi_plugins_app_Application;
filters_glow_Main.prototype = $extend(pixi_plugins_app_Application.prototype,{
	_init: function() {
		this.position = "fixed";
		this.backgroundColor = 16777215;
